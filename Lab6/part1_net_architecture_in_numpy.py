...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [-0.7, 0]  # wagi dla neuronu h1
    model.hidden_layer.W[:, 1] = [0.5, 0]  # wagi dla neuronu h2
    model.hidden_layer.b[:] = [0.1, -0.4]  # biasy dla neuronów h1 i h2
    model.output_layer.W[:, 0] = [0.3, 0.5]  # wagi dla neuronu wyjściowego
    model.output_layer.b[:] = [-0.2]  # bias dla neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    student_id = 196659  # Twój numer indeksu, np. 102247
